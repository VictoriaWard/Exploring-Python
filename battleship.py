...
while str.isdigit(board_col) ==False:                   #checks player has entered number
...
while str.isdigit(board_row) ==False:
    board_row = input("\nTell me the number of rows? (minimum 4) ")
...
while guess <= 10:                  #continues game up to ten guesses
    ...
    while str.isdigit(guess_row) == False:          #checks that player has enter a number 
    ...
    while str.isdigit(guess_col) == False:
